...
@CacheableTask
public abstract class BuildDexTask : DefaultTask() {
    /** Plugin's fat-jar. */
    @get:Classpath public abstract val programJars: ConfigurableFileCollection
    ...
    @get:Input public abstract val relocatedPackages: ListProperty<String>
    ...
    @get:LocalState public abstract val mergedClasspathJar: RegularFileProperty
